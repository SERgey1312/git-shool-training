...
Проект выполнен с использованием фреймворка **_Symfony 5_**. База данных - **_MySQL_**. Для взаимодействия с БД использована **_Doctrine-orm_**. Для реализации графического интерфейса был использован шаблонизатор **_Twig_**, также **_СSS_** + **_Bootstrap_** и **_JavaScript_**. 
***
